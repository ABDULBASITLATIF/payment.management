...
onConfirmSPGL: function (oEvent) {
    ...
    if (oSelectedItem) {
        ...
        onLoadDocTypeVH: async function (oEvent) {
            ...
            this._pDPDocTypeDialog ??= Fragment.load({
                id: oView.getId(),
                name: "zfi.payment.management.fragments.DpFrag.DocTypeVhDP",
                controller: this
            }).then(function (oDialog) {
                oView.addDependent(oDialog);
                return oDialog;
            ...
            const oDialog = await this._pDPDocTypeDialog;
            oDialog.open();
        },
        ...
        onConfirmDocType: function (oEvent) {
            ...
            if (oSelectedItem) {
                ...
                this.byId("dp_doctypeInput").setValue(sDocType);
        ...
        onCloseDocType: function () {
            if (this._pDPDocTypeDialog) {
                this._pDPDocTypeDialog.then(function (oDialog) {
                    oDialog.close();
                });
            }
        }
