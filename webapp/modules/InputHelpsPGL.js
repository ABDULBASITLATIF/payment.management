sap.ui.define([
    ...
    return {
        ...
        onLoadDocTypeVH: async function (oEvent) {
            ...
            this._pGLDocTypeDialog ??= Fragment.load({
                id: oView.getId(),
                name: "zfi.payment.management.fragments.PGLFrag.DocTypeVhPGL",
                controller: this
            }).then(function (oDialog) {
                oView.addDependent(oDialog);
                return oDialog;
            ...
            const oDialog = await this._pGLDocTypeDialog;
            oDialog.open();
        },
        ...
        onConfirmDocType: function (oEvent) {
            ...
            if (oSelectedItem) {
                ...
                this.getView().getModel("glData").setProperty("/values/docType", sDocType);
        ...
        onCloseDocType: function () {
            if (this._pGLDocTypeDialog) {
                this._pGLDocTypeDialog.then(function (oDialog) {
                    oDialog.close();
                });
            }
        }
